...
public partial class TestNullUnhandled : IDiffClass<TestNullUnhandled,TestNullUnhandled.Diff,TestNullUnhandled.DiffGenerator>
{
    ...
    public partial class DiffGenerator : DiffGeneratorBase<TestNullUnhandled,TestNullUnhandled.Diff>
    {
        public static implicit operator DiffGenerator(TestNullUnhandled data) => new(data);
        public DiffGenerator(TestNullUnhandled data) : base(data)
        {
        }
